...
// CONCATENATED MODULE: ./src/components/vue-cal/index.vue?vue&type=template&id=943c8c98&lang=pug&
    ...
    viewCells: function viewCells() {
      ...
      switch (this.view.id) {
        ...
        case 'month':
          ...
          var selectedDateAtMidnight = this.view.selectedDate ? new Date(this.view.selectedDate.getTime()) : new Date(this.view.startDate.getTime());
